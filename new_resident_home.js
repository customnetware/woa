            ...
            if (current_content_class !== null) {
                if (current_content_class.length > 0) {
                    ...
                    for (let i = 0; i < current_content_class.length; i++) {
                        ...
                        content_pp.setAttribute('style', 'padding: 5px; margin-top: 0px; margin-bottom:5px');
                        if (contentDivNum < 3) {
                            ...
                            content_pp.innerHTML = current_content_class[i].innerHTML + current_content_class[i].getElementsByTagName("a")[0].innerHTML
                        } else {
